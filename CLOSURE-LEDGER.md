...
| CL-8 | `dashboard_creator/perses/` — bounded Perses adoption | Neutral model, dual lowerings, pinned CUE/live CLI, pilot golden, and sanitized offline comparison against 14 supplied live Dash0 exports are proven; direct import remains unperformed | **L3** | Authorized Dash0 team follows `docs/design/dashboard-vendor-neutrality/READY_FOR_DASH0_TEAM.md`, imports the exact bare artifact, and returns the sanitized post-import export/evidence → L4/L5 | Vendor-neutral dashboard generation is proven at its first real consumer |
