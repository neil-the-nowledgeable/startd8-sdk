...
from startd8.backend_codegen.context_manifest import contract_sha256, filter_spec_for_client
...
def test_m4_filtered_contract_hash_stable(tmp_path: Path) -> None:
    ...
    filtered = filter_spec_for_client(raw, CONSUMER_SCHEMA, routes="crud")
