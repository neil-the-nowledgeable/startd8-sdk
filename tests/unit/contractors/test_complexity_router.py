...
class TestTaskComplexitySignals:
    ...
    def test_to_dict(self) -> None:
        ...
        # Shape guard: all 15 fields incl. file_extension, security_sensitive,
        # has_fillable_elements (RUN-007 FR-7), and manifest_element_count.
        assert len(d) == 15
        assert "has_fillable_elements" in d and "manifest_element_count" in d
