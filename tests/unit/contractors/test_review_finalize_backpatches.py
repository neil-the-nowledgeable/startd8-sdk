...
class TestIP1ImplementPhaseOutputValidator:
    """ImplementPhaseOutput accepts generation_results as Dict[str, Any].

    Values can be GenerationResult NamedTuples or plain dicts — the model
    only enforces that the top-level container is a dict (via Pydantic's
    type annotation).
    """
