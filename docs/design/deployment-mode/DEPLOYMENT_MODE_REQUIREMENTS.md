...
**Date:** 2026-06-11
**Status:** IMPLEMENTED — Tier A (M0/M1/M2) **and** Tier B tenancy (M3) core shipped (see
`DEPLOYMENT_MODE_PLAN.md` "M3 / Tier B tenancy — CORE DONE"). *(Marker updated 2026-07-02 — was
"Draft"; the "Tier B / tenancy DEFERRED" framing below is superseded — tenant-scoped routers/web +
`deployment.tenant` declaration + isolation tests are on main.)*
