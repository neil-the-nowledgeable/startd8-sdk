...
- run_id: s2-codex-spec-clean-20260618T213255Z
- author_vendor: openai
- authoring_surface: codex_cli
- model_id: codex-cli-default
- prompt_template_version: spec-author.v0.1
- artifact_type: spec
- working_directory: /private/tmp/startd8-openai-bias-clean-workspace/outputs/s2-codex-spec-clean-20260618T213255Z
...
- isolation_note: This spec-author run intentionally does not include prior proto-collection output.
...
- No implementation runtime dependencies.
