...
|---|---|---|---|
| REQ-MP-1100 | Element Registry Core | P0 | planned |
| REQ-MP-1101 | Manifest Element Index | P0 | planned |
...
| REQ-MP-1106 | DeterministicFileAssembler Pre-Fill | P2 | planned |
| REQ-MP-1107 | Element Registry Observability | P2 | planned |
| REQ-MP-1108 | Registry Staleness and Invalidation | P2 | planned |
