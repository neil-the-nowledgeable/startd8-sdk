...
|-------|----------|-------|-------------|---------|---------|
| Model Selection & Tuning | REQ-MP-1xx | 5 | 5 | 0 | 0 |
| Skeleton-First Prompting | REQ-MP-2xx | 6 | 6 | 0 | 0 |
| Template Registry | REQ-MP-3xx | 5 | 5 | 0 | 0 |
| Manifest-Guided Repair | REQ-MP-4xx | 8 | 8 | 0 | 0 |
...
| REQ-MP-906 | Decomposition Metrics and Observability | P1 | implemented |
| REQ-MP-907 | Decomposition Strategy Registry | P1 | implemented |
| REQ-MP-908 | Configuration | P2 | implemented |
| REQ-MP-909 | Prime Adapter Integration | P0 | implemented |
...
| REQ-MP-103 | `Modelfile.startd8-coder` | Stop sequence validation (manual) | implemented |
| REQ-MP-104 | `src/startd8/model_catalog.py` | — | implemented |
| REQ-MP-200 | `src/startd8/micro_prime/prompt_builder.py` | `tests/unit/micro_prime/test_prompt_builder.py` | implemented |
| REQ-MP-201 | `src/startd8/micro_prime/prompt_builder.py` | `tests/unit/micro_prime/test_prompt_builder.py` | implemented |
| REQ-MP-202 | `src/startd8/micro_prime/splicer.py` | `tests/unit/micro_prime/test_splicer.py` | implemented |
| REQ-MP-203 | `src/startd8/micro_prime/prompt_builder.py` | `tests/unit/micro_prime/test_prompt_builder.py` | implemented |
| REQ-MP-204 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-205 | `src/startd8/micro_prime/prompt_builder.py` | `tests/unit/micro_prime/test_prompt_builder.py` | implemented |
| REQ-MP-300 | `src/startd8/micro_prime/templates.py` | `tests/unit/micro_prime/test_templates.py` | implemented |
| REQ-MP-301 | `src/startd8/micro_prime/templates.py` | `tests/unit/micro_prime/test_templates.py` | implemented |
| REQ-MP-302 | `src/startd8/micro_prime/templates.py` | `tests/unit/micro_prime/test_templates.py` | implemented |
| REQ-MP-303 | `src/startd8/micro_prime/templates.py` | `tests/unit/micro_prime/test_templates.py` | implemented |
| REQ-MP-304 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-400 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-401 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-402 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-403 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-404 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-405 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-406 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-407 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-500 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-501 | `src/startd8/micro_prime/classifier.py` | `tests/unit/micro_prime/test_classifier.py` | implemented |
| REQ-MP-502 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-503 | `src/startd8/micro_prime/artisan_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-504 | `src/startd8/micro_prime/artisan_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-505 | `src/startd8/micro_prime/splicer.py` | `tests/unit/micro_prime/test_splicer.py` | implemented |
| REQ-MP-506 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-507 | `src/startd8/micro_prime/prime_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-508 | `src/startd8/micro_prime/artisan_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-509 | `src/startd8/micro_prime/context.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-510 | `src/startd8/micro_prime/prime_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-511 | `src/startd8/micro_prime/classifier.py` | `tests/unit/micro_prime/test_classifier.py` | implemented |
| REQ-MP-512 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-513 | `src/startd8/micro_prime/prime_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-514 | `src/startd8/micro_prime/prime_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-515 | `src/startd8/micro_prime/models.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-600 | `src/startd8/micro_prime/metrics.py` | `tests/unit/micro_prime/test_metrics.py` | implemented |
| REQ-MP-601 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-602 | `src/startd8/micro_prime/metrics.py` | `tests/unit/micro_prime/test_metrics.py` | implemented |
| REQ-MP-603 | `src/startd8/micro_prime/metrics.py` | `tests/unit/micro_prime/test_metrics.py` | implemented |
| REQ-MP-700 | Cross-cutting (delegation contracts) | Code review | implemented |
| REQ-MP-701 | `src/startd8/micro_prime/` (multiple) | `tests/unit/micro_prime/` (multiple) | implemented |
| REQ-MP-702 | `src/startd8/micro_prime/splicer.py` | `tests/unit/micro_prime/test_splicer.py` | implemented |
| REQ-MP-703 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-704 | `src/startd8/micro_prime/engine.py` | `tests/unit/micro_prime/test_engine.py` | implemented |
| REQ-MP-705 | `src/startd8/micro_prime/prime_adapter.py` | `tests/unit/micro_prime/test_adapters.py` | implemented |
| REQ-MP-706 | `src/startd8/micro_prime/repair.py` | `tests/unit/micro_prime/test_repair.py` | implemented |
| REQ-MP-707 | `src/startd8/model_catalog.py` | — | implemented |
| REQ-MP-708 | `src/startd8/micro_prime/classifier.py` | `tests/unit/micro_prime/test_classifier.py` | implemented |
