...
**Generated:** 2026-06-03 19:27:04 UTC
...
| Role | Path | Size |
|------|------|------|
| **Plan** | `/Users/neilyashinsky/Documents/dev/startd8-sdk/docs/design/controlled-corpus/CONTROLLED_CORPUS_IMPLEMENTATION_PLAN.md` | 124 lines · 971 words |
| **Requirements** | `/Users/neilyashinsky/Documents/dev/startd8-sdk/docs/design/controlled-corpus/CONTROLLED_CORPUS_REQUIREMENTS.md` | 190 lines · 1822 words |
...
| **Review focus (sponsor)** | `/Users/neilyashinsky/Documents/dev/startd8-sdk/docs/design/controlled-corpus/crp-focus.md` | 26 lines · 226 words |
...
**Path:** `/Users/neilyashinsky/Documents/dev/startd8-sdk/docs/design/controlled-corpus/CONTROLLED_CORPUS_IMPLEMENTATION_PLAN.md`  ·  **Size:** 124 lines · 971 words
...
**Path:** `/Users/neilyashinsky/Documents/dev/startd8-sdk/docs/design/controlled-corpus/CONTROLLED_CORPUS_REQUIREMENTS.md`  ·  **Size:** 190 lines · 1822 words
...
- **FR-2 — Corpus entry shape.** Each entry SHALL carry: `term_id`; `kind` ∈
  ...
  (reusing forward_manifest's EXPLICIT/INFERRED/ADVISORY); `maturity` (0–4); `recurrence`
  (`source_run_ids[]`); and `determinism` (`{stability, n_observations, last_slope}`).
...
- **FR-8 — Two-axis determinism classification.** *(Refined during oracle-v2 build — see
  ...
  **and** `requirement_score` (semantic), because they diverge: `shoppingassistantservice.py` showed
  ...
  `deterministic_candidate` (stability ≥0.95 **and** requirement_score ≥0.9),
  **`false_pass_risk`** (stability ≥0.95 **but** requirement_score <0.7),
  `residue_corpus_gap` (stability <0.7), or `mixed`. The corpus SHALL **never promote a
  `false_pass_risk` binding to a deterministic provider** on structural stability alone, and SHALL
  surface `false_pass_risk` bindings as mandatory SCR escalations (FR-10).
