...
_CANONICAL_ORDER = [
    ...
    "python_convention_fix",
    "starlette_response_fix",
    "csharp_nullable_fix",
...
_ROUTING_TABLE: list[tuple[str, str, list[str], str, Optional[str]]] = [
    ...
    ("convention", "python_convention_error", ["python_convention_fix", "ast_validate"], "MEDIUM", "python"),
    ("convention", "python_starlette_response_error", ["starlette_response_fix", "ast_validate"], "MEDIUM", "python"),
...
_STEP_FACTORIES: dict[str, type] = {
    ...
    "python_convention_fix": PythonConventionFixStep,
    "starlette_response_fix": StarletteResponseFixStep,
