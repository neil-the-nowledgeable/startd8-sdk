...
class Candidate:
    ...
    raw_text: str  # the verbatim item text (bounded)
...
class TriageReport:
    ...
    def to_markdown(self) -> str:
        ...
        lines = [
            ...
            f"NON_DECIDABLE {c['NON_DECIDABLE']}",
        ]
        if self.health:
